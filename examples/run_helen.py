...
# === Run CCART for Cyclone Helen ===
gdf = run_ccart(
    cyclone_name="Helen",
    storm_id="2013322N13090",   # Correct SID for Helen
    ...
    dlna_total=500e6,           # India DLNA ≈ USD 0.5B
...
if gdf["loss_usd_hwe"].sum() > 0:
    ccart_choropleth(
        ...
        title="Cyclone Helen – CCART Loss Map (Andhra Pradesh)"
    )
else:
