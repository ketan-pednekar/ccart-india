...
# === Run CCART for Cyclone Aila ===
gdf = run_ccart(
    cyclone_name="Aila",
    storm_id="2009143N17089",   # Correct SID for Aila
    ...
    dlna_total=1200e6,          # India DLNA ≈ USD 1.2B
    state_name="WEST BENGAL",   # Primary calibration state
    inland_clip_km=150,
...
if gdf["loss_usd_hwe"].sum() > 0:
    ccart_choropleth(
        ...
        title="Cyclone Aila – CCART Loss Map (West Bengal)"
    )
else:
