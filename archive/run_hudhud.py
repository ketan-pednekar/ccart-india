...
# === Run CCART for Cyclone Hudhud ===
gdf = run_ccart(
    cyclone_name="Hudhud",
    storm_id="2014279N11096",   # Confirmed SID
    ...
    dlna_total=3500e6,          # India DLNA ≈ USD 3.5B (Nepal excluded)
...
if gdf["loss_usd_hwe"].sum() > 0:
    ccart_choropleth(
        ...
        title="Cyclone Hudhud – CCART Loss Map (Andhra Pradesh)"
    )
else:
